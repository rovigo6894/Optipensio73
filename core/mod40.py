...
def calcular_mod40(edad, semanas, salario, salario_m40, meses_m40, esposa=True):
    """
    ...
    # Usamos la misma fórmula que en calculadora_pension.py
    from core.calculadora_pension import calcular_pension_ley73
    resultado_base = calcular_pension_ley73(salario, semanas, edad, 60, 0, esposa)
    pension_base = resultado_base[0]  # Primer valor del tuple
    
    # --- 5. CALCULAR NUEVA PENSIÓN CON M40 ---
    años_para_retiro = max(0, 60 - edad)
    ...
    DECRETO_FOX = 0.11
    AJUSTE_FINAL = 1.2166
    FACTOR_EDAD = 0.75  # Retiro a los 60 años
